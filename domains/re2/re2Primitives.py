...
from dreamcoder_programs.program import Primitive, Program
from dreamcoder_programs.grammar import Grammar
from dreamcoder_programs.type import tint, tlist, arrow, baseType, tbool, t0, t1
from dreamcoder_programs.domains.text.textPrimitives import (
    re2_text_primitives,
    re2_text_4_letter,
    re2_text_6_letter,
    re2_text_characters,
)
from dreamcoder_programs.domains.list.listPrimitives import (
    re2_list_v0,
    _cons,
    _car,
    _cdr,
