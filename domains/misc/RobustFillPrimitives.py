...
from dreamcoder_programs.program import Primitive, prettyProgram
from dreamcoder_programs.grammar import Grammar
from dreamcoder_programs.type import tint, arrow, baseType  # , t0, t1, t2
...
def _gettoken_const(tp, i):
    return (
        defaultdict(int, {tp: i + 1 if i >= 0 else abs(i)}),
